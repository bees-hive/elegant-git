...
newtype GRemote = GRemote {_grmName :: Text}
  deriving (Eq, Show)

makeLenses ''GRemote

data GRepository = GRepository
  { _grRemotes :: [GRemote]
  , _grBranches :: [GBranch]
